...
BINDEROBJECTS = binder.o segment.o message.o register_request_message.o register_success_message.o register_failure_message.o loc_request_message.o loc_success_message.o loc_failure_message.o constants.o helper_function.o 
